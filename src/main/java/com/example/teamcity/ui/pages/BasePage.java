...
public class BasePage {
    ...
    /**
     * передали коллекцию, из которой потом хотим сделать
     * список элементов (провести генерацию) и функцию (описывающую конструктор) создания,
     * назвали creator, которая умеет работать с типом данных элемент селенида и дженерик
     * Function<X, Y> — это "функция, которая принимает X и возвращает Y".
     *
     * T — любой класс, который наследуется от BasePageElement
     */
